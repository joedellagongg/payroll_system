<?php
    ...
    if(isset($_POST["delete"]) && isset($_POST["deleteId"])){
        foreach($_POST["deleteId"] as $deleteId){
          $delete = "DELETE FROM emp_sched WHERE sched_id = $deleteId";
...
<div class="nav">
    ...
    <br>
        ...
        <a href="../schedule/ti-to.php">
          ATTENDANCE
        </a>
      </aside>

    <a href="../homepage/home_page.php"><button class="bahay"><i class="fa-solid fa-house"></i></button></a>
    <a href="../schedule/employee_schedule.php"><button class="ae">+</button></a>
...
<button name="delete" type="submit" class="deleteButton"> <i class="fa-solid fa-trash" style="color: #ff0000;"></i></button>
    ...
    <div class="table-wrapper">
        ...
        <tr>
            <th class="tg-et4c"></th>
            <th class="tg-et4c">SCHEDULE IN</th>
            <th class="tg-et4c">SCHEDULE OUT</th>
    ...
    <tbody>
        ...
        ?>
        <td align="center"> 
            <input type="checkbox" name="deleteId[]" value="<?php echo $row['sched_id']; ?>">
        </td>
        <td class="tg-0pky"><?php echo $row["sched_in"]; ?></td>
        <td class="tg-0pky"><?php echo $row["sched_out"]; ?></td>
        <td class="tg-0pky">
            <form action="http://localhost/Payroll_System/login_phase/masterlist/update.php" method="GET">
                <button class="aksyon" type="submit" name="view" value="<?php echo $row["sched_id"]; ?>">
